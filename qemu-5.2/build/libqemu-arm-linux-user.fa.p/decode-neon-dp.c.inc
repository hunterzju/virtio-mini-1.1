...
typedef arg_2reg_shift arg_VCVT_SH_2sh;
static bool trans_VCVT_SH_2sh(DisasContext *ctx, arg_VCVT_SH_2sh *a);
typedef arg_2reg_shift arg_VCVT_UH_2sh;
static bool trans_VCVT_UH_2sh(DisasContext *ctx, arg_VCVT_UH_2sh *a);
typedef arg_2reg_shift arg_VCVT_HS_2sh;
static bool trans_VCVT_HS_2sh(DisasContext *ctx, arg_VCVT_HS_2sh *a);
typedef arg_2reg_shift arg_VCVT_HU_2sh;
static bool trans_VCVT_HU_2sh(DisasContext *ctx, arg_VCVT_HU_2sh *a);
...
static void disas_neon_dp_extract_2reg_vcvt_f16(DisasContext *ctx, arg_2reg_shift *a, uint32_t insn)
{
    a->q = extract32(insn, 6, 1);
    a->vm = deposit32(extract32(insn, 0, 4), 4, 28, extract32(insn, 5, 1));
    a->vd = deposit32(extract32(insn, 12, 4), 4, 28, extract32(insn, 22, 1));
...
static void disas_neon_dp_extract_disas_neon_dp_Fmt_25(DisasContext *ctx, arg_disas_neon_dp3 *a, uint32_t insn)
{
...
static void disas_neon_dp_extract_disas_neon_dp_Fmt_26(DisasContext *ctx, arg_disas_neon_dp4 *a, uint32_t insn)
{
...
static void disas_neon_dp_extract_disas_neon_dp_Fmt_29(DisasContext *ctx, arg_disas_neon_dp5 *a, uint32_t insn)
{
...
static bool disas_neon_dp(DisasContext *ctx, uint32_t insn)
{
    ...
    case 0xf2000000:
        ...
        case 0x00000d00:
            ...
            case 0x0:
                /* 11110010 0.0..... ....1101 ...0.... */
                /* ../target/arm/neon-dp.decode:189 */
                if (trans_VADD_fp_3s(ctx, &u.f_3same)) return true;
                break;
            case 0x1:
                /* 11110010 0.1..... ....1101 ...0.... */
                /* ../target/arm/neon-dp.decode:190 */
        ...
        case 0x00000f00:
            ...
            case 0x0:
                /* 11110010 0.0..... ....1111 ...0.... */
                /* ../target/arm/neon-dp.decode:201 */
                if (trans_VMAX_fp_3s(ctx, &u.f_3same)) return true;
                break;
            case 0x1:
                /* 11110010 0.1..... ....1111 ...0.... */
                /* ../target/arm/neon-dp.decode:202 */
        ...
        case 0x01000100:
            /* 11110011 0....... ....0001 ...0.... */
            /* ../target/arm/neon-dp.decode:65 */
            disas_neon_dp_extract_3same(ctx, &u.f_3same, insn);
            if (trans_VRHADD_U_3s(ctx, &u.f_3same)) return true;
            break;
        case 0x01000200:
            /* 11110011 0....... ....0010 ...0.... */
            /* ../target/arm/neon-dp.decode:80 */
            disas_neon_dp_extract_3same(ctx, &u.f_3same, insn);
        ...
        case 0x01000e00:
            ...
            case 0x0:
                /* 11110011 0.0..... ....1110 ...0.... */
                /* ../target/arm/neon-dp.decode:197 */
                if (trans_VCGE_fp_3s(ctx, &u.f_3same)) return true;
                break;
            case 0x1:
                /* 11110011 0.1..... ....1110 ...0.... */
                /* ../target/arm/neon-dp.decode:199 */
    ...
    case 0xf2000010:
        ...
        case 0x00000200:
            /* 11110010 0....... ....0010 ...1.... */
            /* ../target/arm/neon-dp.decode:82 */
            disas_neon_dp_extract_3same(ctx, &u.f_3same, insn);
            if (trans_VQSUB_S_3s(ctx, &u.f_3same)) return true;
            break;
        case 0x00000300:
            /* 11110010 0....... ....0011 ...1.... */
            /* ../target/arm/neon-dp.decode:87 */
            disas_neon_dp_extract_3same(ctx, &u.f_3same, insn);
        ...
        case 0x00000c00:
            ...
            case 0x0:
                /* 11110010 0.0..... ....1100 ...1.... */
                /* ../target/arm/neon-dp.decode:184 */
                if (trans_VFMA_fp_3s(ctx, &u.f_3same)) return true;
                break;
            case 0x1:
                /* 11110010 0.1..... ....1100 ...1.... */
                /* ../target/arm/neon-dp.decode:185 */
        ...
        case 0x00000d00:
            ...
            case 0x0:
                /* 11110010 0.0..... ....1101 ...1.... */
                /* ../target/arm/neon-dp.decode:193 */
                if (trans_VMLA_fp_3s(ctx, &u.f_3same)) return true;
                break;
            case 0x1:
                /* 11110010 0.1..... ....1101 ...1.... */
                /* ../target/arm/neon-dp.decode:194 */
        ...
        case 0x00000f00:
            ...
            case 0x0:
                /* 11110010 0.0..... ....1111 ...1.... */
                /* ../target/arm/neon-dp.decode:205 */
                if (trans_VRECPS_fp_3s(ctx, &u.f_3same)) return true;
                break;
            case 0x1:
                /* 11110010 0.1..... ....1111 ...1.... */
                /* ../target/arm/neon-dp.decode:206 */
        ...
        case 0x01000200:
            /* 11110011 0....... ....0010 ...1.... */
            /* ../target/arm/neon-dp.decode:83 */
            disas_neon_dp_extract_3same(ctx, &u.f_3same, insn);
            if (trans_VQSUB_U_3s(ctx, &u.f_3same)) return true;
            break;
        case 0x01000300:
            /* 11110011 0....... ....0011 ...1.... */
            /* ../target/arm/neon-dp.decode:88 */
            disas_neon_dp_extract_3same(ctx, &u.f_3same, insn);
        ...
        case 0x01000400:
            ...
            if ((insn & 0x00300000) == 0x00300000) {
                ...
                /* ../target/arm/neon-dp.decode:117 */
                disas_neon_dp_extract_3same_64_rev(ctx, &u.f_3same, insn);
                if (trans_VQSHL_U64_3s(ctx, &u.f_3same)) return true;
            }
            /* ../target/arm/neon-dp.decode:118 */
            disas_neon_dp_extract_3same_rev(ctx, &u.f_3same, insn);
        ...
        case 0x01000b00:
            /* 11110011 0....... ....1011 ...1.... */
            /* ../target/arm/neon-dp.decode:171 */
            disas_neon_dp_extract_3same(ctx, &u.f_3same, insn);
            if (trans_VQRDMLAH_3s(ctx, &u.f_3same)) return true;
            break;
        case 0x01000c00:
            /* 11110011 0....... ....1100 ...1.... */
            /* ../target/arm/neon-dp.decode:187 */
            disas_neon_dp_extract_3same(ctx, &u.f_3same, insn);
        ...
        case 0x01000e00:
            ...
            case 0x0:
                /* 11110011 0.0..... ....1110 ...1.... */
                /* ../target/arm/neon-dp.decode:198 */
                if (trans_VACGE_fp_3s(ctx, &u.f_3same)) return true;
                break;
            case 0x1:
                /* 11110011 0.1..... ....1110 ...1.... */
                /* ../target/arm/neon-dp.decode:200 */
        ...
        case 0x01000f00:
            ...
            case 0x0:
                /* 11110011 0.0..... ....1111 ...1.... */
                /* ../target/arm/neon-dp.decode:207 */
                if (trans_VMAXNM_fp_3s(ctx, &u.f_3same)) return true;
                break;
            case 0x1:
                /* 11110011 0.1..... ....1111 ...1.... */
                /* ../target/arm/neon-dp.decode:208 */
    ...
    case 0xf2800000:
        ...
        if ((insn & 0x00300000) == 0x00300000) {
            ...
            case 0x0:
                /* 11110010 1.11.... ........ ...0.... */
                /* ../target/arm/neon-dp.decode:430 */
                disas_neon_dp_extract_disas_neon_dp_Fmt_25(ctx, &u.f_disas_neon_dp3, insn);
            ...
            case 0x1:
                ...
                case 0x2:
                    /* 11110011 1.11.... ....10.. ...0.... */
                    /* ../target/arm/neon-dp.decode:433 */
                    disas_neon_dp_extract_disas_neon_dp_Fmt_26(ctx, &u.f_disas_neon_dp4, insn);
                    ...
                    case 0x00000000:
                        ...
                        case 0x0:
                            ...
                            case 0x1:
                                ...
                                /* ../target/arm/neon-dp.decode:440 */
                                disas_neon_dp_extract_disas_neon_dp_Fmt_29(ctx, &u.f_disas_neon_dp5, insn);
        ...
        case 0x00000100:
            ...
            case 0x0:
                /* 11110010 1....... ....0001 .0.0.... */
                /* ../target/arm/neon-dp.decode:565 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
                if (trans_VADDW_S_3d(ctx, &u.f_3diff)) return true;
                break;
            case 0x1:
                /* 11110011 1....... ....0001 .0.0.... */
                /* ../target/arm/neon-dp.decode:566 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
        ...
        case 0x00000200:
            ...
            case 0x0:
                /* 11110010 1....... ....0010 .0.0.... */
                /* ../target/arm/neon-dp.decode:568 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
                if (trans_VSUBL_S_3d(ctx, &u.f_3diff)) return true;
                break;
            case 0x1:
                /* 11110011 1....... ....0010 .0.0.... */
                /* ../target/arm/neon-dp.decode:569 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
        ...
        case 0x00000300:
            ...
            case 0x0:
                /* 11110010 1....... ....0011 .0.0.... */
                /* ../target/arm/neon-dp.decode:571 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
                if (trans_VSUBW_S_3d(ctx, &u.f_3diff)) return true;
                break;
            case 0x1:
                /* 11110011 1....... ....0011 .0.0.... */
                /* ../target/arm/neon-dp.decode:572 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
        ...
        case 0x00000400:
            ...
            case 0x0:
                /* 11110010 1....... ....0100 .0.0.... */
                /* ../target/arm/neon-dp.decode:574 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
                if (trans_VADDHN_3d(ctx, &u.f_3diff)) return true;
                break;
            case 0x1:
                /* 11110011 1....... ....0100 .0.0.... */
                /* ../target/arm/neon-dp.decode:575 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
        ...
        case 0x00000500:
            ...
            case 0x0:
                /* 11110010 1....... ....0101 .0.0.... */
                /* ../target/arm/neon-dp.decode:577 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
                if (trans_VABAL_S_3d(ctx, &u.f_3diff)) return true;
                break;
            case 0x1:
                /* 11110011 1....... ....0101 .0.0.... */
                /* ../target/arm/neon-dp.decode:578 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
        ...
        case 0x00000600:
            ...
            case 0x0:
                /* 11110010 1....... ....0110 .0.0.... */
                /* ../target/arm/neon-dp.decode:580 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
                if (trans_VSUBHN_3d(ctx, &u.f_3diff)) return true;
                break;
            case 0x1:
                /* 11110011 1....... ....0110 .0.0.... */
                /* ../target/arm/neon-dp.decode:581 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
        ...
        case 0x00000640:
            ...
            case 0x0:
                /* 11110010 1....... ....0110 .1.0.... */
                /* ../target/arm/neon-dp.decode:626 */
                disas_neon_dp_extract_2scalar_q0(ctx, &u.f_2scalar, insn);
                if (trans_VMLSL_S_2sc(ctx, &u.f_2scalar)) return true;
                break;
            case 0x1:
                /* 11110011 1....... ....0110 .1.0.... */
                /* ../target/arm/neon-dp.decode:627 */
                disas_neon_dp_extract_2scalar_q0(ctx, &u.f_2scalar, insn);
        ...
        case 0x00000700:
            ...
            case 0x0:
                /* 11110010 1....... ....0111 .0.0.... */
                /* ../target/arm/neon-dp.decode:583 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
                if (trans_VABDL_S_3d(ctx, &u.f_3diff)) return true;
                break;
            case 0x1:
                /* 11110011 1....... ....0111 .0.0.... */
                /* ../target/arm/neon-dp.decode:584 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
        ...
        case 0x00000800:
            ...
            case 0x0:
                /* 11110010 1....... ....1000 .0.0.... */
                /* ../target/arm/neon-dp.decode:586 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
                if (trans_VMLAL_S_3d(ctx, &u.f_3diff)) return true;
                break;
            case 0x1:
                /* 11110011 1....... ....1000 .0.0.... */
                /* ../target/arm/neon-dp.decode:587 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
        ...
        case 0x00000a00:
            ...
            case 0x0:
                /* 11110010 1....... ....1010 .0.0.... */
                /* ../target/arm/neon-dp.decode:591 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
                if (trans_VMLSL_S_3d(ctx, &u.f_3diff)) return true;
                break;
            case 0x1:
                /* 11110011 1....... ....1010 .0.0.... */
                /* ../target/arm/neon-dp.decode:592 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
        ...
        case 0x00000c00:
            ...
            case 0x0:
                /* 11110010 1....... ....1100 .0.0.... */
                /* ../target/arm/neon-dp.decode:596 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
                if (trans_VMULL_S_3d(ctx, &u.f_3diff)) return true;
                break;
            case 0x1:
                /* 11110011 1....... ....1100 .0.0.... */
                /* ../target/arm/neon-dp.decode:597 */
                disas_neon_dp_extract_3diff(ctx, &u.f_3diff, insn);
        ...
        case 0x00000e40:
            /* 1111001. 1....... ....1110 .1.0.... */
            /* ../target/arm/neon-dp.decode:642 */
            disas_neon_dp_extract_2scalar(ctx, &u.f_2scalar, insn);
            if (trans_VQRDMLAH_2sc(ctx, &u.f_2scalar)) return true;
            break;
        case 0x00000f40:
            /* 1111001. 1....... ....1111 .1.0.... */
            /* ../target/arm/neon-dp.decode:643 */
            disas_neon_dp_extract_2scalar(ctx, &u.f_2scalar, insn);
    ...
    case 0xf2800010:
            ...
            case 0x0:
                ...
                case 0x1:
                    ...
                    case 0x01000000:
                        ...
                        /* ../target/arm/neon-dp.decode:271 */
                        disas_neon_dp_extract_2reg_shr_h(ctx, &u.f_2reg_shift, insn);
                        if (trans_VSHR_U_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    case 0x01000100:
                        /* 11110011 1.01.... ....0001 0..1.... */
                        /* ../target/arm/neon-dp.decode:281 */
                        disas_neon_dp_extract_2reg_shr_h(ctx, &u.f_2reg_shift, insn);
                        if (trans_VSRA_U_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    case 0x01000200:
                        /* 11110011 1.01.... ....0010 0..1.... */
                        /* ../target/arm/neon-dp.decode:291 */
                        disas_neon_dp_extract_2reg_shr_h(ctx, &u.f_2reg_shift, insn);
                        if (trans_VRSHR_U_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    case 0x01000300:
                        /* 11110011 1.01.... ....0011 0..1.... */
                        /* ../target/arm/neon-dp.decode:301 */
                        disas_neon_dp_extract_2reg_shr_h(ctx, &u.f_2reg_shift, insn);
                        if (trans_VRSRA_U_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    case 0x01000400:
                        /* 11110011 1.01.... ....0100 0..1.... */
                        /* ../target/arm/neon-dp.decode:306 */
                        disas_neon_dp_extract_2reg_shr_h(ctx, &u.f_2reg_shift, insn);
                        if (trans_VSRI_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    case 0x01000500:
                        /* 11110011 1.01.... ....0101 0..1.... */
                        /* ../target/arm/neon-dp.decode:316 */
                        disas_neon_dp_extract_2reg_shl_h(ctx, &u.f_2reg_shift, insn);
                        if (trans_VSLI_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    case 0x01000600:
                        /* 11110011 1.01.... ....0110 0..1.... */
                        /* ../target/arm/neon-dp.decode:321 */
                        disas_neon_dp_extract_2reg_shl_h(ctx, &u.f_2reg_shift, insn);
                        if (trans_VQSHLU_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    case 0x01000700:
                        /* 11110011 1.01.... ....0111 0..1.... */
                        /* ../target/arm/neon-dp.decode:331 */
                        disas_neon_dp_extract_2reg_shl_h(ctx, &u.f_2reg_shift, insn);
                        if (trans_VQSHL_U_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    case 0x01000800:
            ...
            case 0x1:
                ...
                case 0x00000a00:
                    ...
                    case 0x0:
                        ...
                        /* ../target/arm/neon-dp.decode:370 */
                        if (trans_VSHLL_S_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    }
                    break;
                case 0x00000c00:
                    /* 11110010 1.1..... ....1100 0..1.... */
                    disas_neon_dp_extract_2reg_vcvt_f16(ctx, &u.f_2reg_shift, insn);
                    switch ((insn >> 20) & 0x1) {
                    case 0x1:
                        /* 11110010 1.11.... ....1100 0..1.... */
                        /* ../target/arm/neon-dp.decode:379 */
                        if (trans_VCVT_SH_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    }
                    break;
                case 0x00000d00:
                    /* 11110010 1.1..... ....1101 0..1.... */
                    disas_neon_dp_extract_2reg_vcvt_f16(ctx, &u.f_2reg_shift, insn);
                    switch ((insn >> 20) & 0x1) {
                    case 0x1:
                        /* 11110010 1.11.... ....1101 0..1.... */
                        /* ../target/arm/neon-dp.decode:381 */
                        if (trans_VCVT_HS_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    }
                    break;
                case 0x00000e00:
                    /* 11110010 1.1..... ....1110 0..1.... */
                    /* ../target/arm/neon-dp.decode:384 */
                ...
                case 0x01000200:
                    ...
                    /* ../target/arm/neon-dp.decode:290 */
                    disas_neon_dp_extract_2reg_shr_s(ctx, &u.f_2reg_shift, insn);
                    if (trans_VRSHR_U_2sh(ctx, &u.f_2reg_shift)) return true;
                    break;
                case 0x01000300:
                    /* 11110011 1.1..... ....0011 0..1.... */
                    /* ../target/arm/neon-dp.decode:300 */
                    disas_neon_dp_extract_2reg_shr_s(ctx, &u.f_2reg_shift, insn);
                    if (trans_VRSRA_U_2sh(ctx, &u.f_2reg_shift)) return true;
                    break;
                case 0x01000400:
                    /* 11110011 1.1..... ....0100 0..1.... */
                    /* ../target/arm/neon-dp.decode:305 */
                    disas_neon_dp_extract_2reg_shr_s(ctx, &u.f_2reg_shift, insn);
                    if (trans_VSRI_2sh(ctx, &u.f_2reg_shift)) return true;
                    break;
                case 0x01000500:
                    /* 11110011 1.1..... ....0101 0..1.... */
                    /* ../target/arm/neon-dp.decode:315 */
                    disas_neon_dp_extract_2reg_shl_s(ctx, &u.f_2reg_shift, insn);
                    if (trans_VSLI_2sh(ctx, &u.f_2reg_shift)) return true;
                    break;
                case 0x01000600:
                    /* 11110011 1.1..... ....0110 0..1.... */
                    /* ../target/arm/neon-dp.decode:320 */
                    disas_neon_dp_extract_2reg_shl_s(ctx, &u.f_2reg_shift, insn);
                    if (trans_VQSHLU_2sh(ctx, &u.f_2reg_shift)) return true;
                    break;
                case 0x01000700:
                    /* 11110011 1.1..... ....0111 0..1.... */
                    /* ../target/arm/neon-dp.decode:330 */
                    disas_neon_dp_extract_2reg_shl_s(ctx, &u.f_2reg_shift, insn);
                    if (trans_VQSHL_U_2sh(ctx, &u.f_2reg_shift)) return true;
                    break;
                case 0x01000800:
                ...
                case 0x01000a00:
                    ...
                    case 0x0:
                        ...
                        /* ../target/arm/neon-dp.decode:374 */
                        if (trans_VSHLL_U_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    }
                    break;
                case 0x01000c00:
                    /* 11110011 1.1..... ....1100 0..1.... */
                    disas_neon_dp_extract_2reg_vcvt_f16(ctx, &u.f_2reg_shift, insn);
                    switch ((insn >> 20) & 0x1) {
                    case 0x1:
                        /* 11110011 1.11.... ....1100 0..1.... */
                        /* ../target/arm/neon-dp.decode:380 */
                        if (trans_VCVT_UH_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    }
                    break;
                case 0x01000d00:
                    /* 11110011 1.1..... ....1101 0..1.... */
                    disas_neon_dp_extract_2reg_vcvt_f16(ctx, &u.f_2reg_shift, insn);
                    switch ((insn >> 20) & 0x1) {
                    case 0x1:
                        /* 11110011 1.11.... ....1101 0..1.... */
                        /* ../target/arm/neon-dp.decode:382 */
                        if (trans_VCVT_HU_2sh(ctx, &u.f_2reg_shift)) return true;
                        break;
                    }
                    break;
                case 0x01000e00:
                    /* 11110011 1.1..... ....1110 0..1.... */
                    /* ../target/arm/neon-dp.decode:385 */
                    disas_neon_dp_extract_2reg_vcvt(ctx, &u.f_2reg_shift, insn);
                    if (trans_VCVT_UF_2sh(ctx, &u.f_2reg_shift)) return true;
                    break;
                case 0x01000f00:
                    /* 11110011 1.1..... ....1111 0..1.... */
                    /* ../target/arm/neon-dp.decode:387 */
                    disas_neon_dp_extract_2reg_vcvt(ctx, &u.f_2reg_shift, insn);
        ...
        case 0x1:
            ...
            case 0x00000000:
                /* 11110010 1....... ....0000 1..1.... */
                /* ../target/arm/neon-dp.decode:264 */
                disas_neon_dp_extract_2reg_shr_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VSHR_S_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x00000100:
                /* 11110010 1....... ....0001 1..1.... */
                /* ../target/arm/neon-dp.decode:274 */
                disas_neon_dp_extract_2reg_shr_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VSRA_S_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x00000200:
                /* 11110010 1....... ....0010 1..1.... */
                /* ../target/arm/neon-dp.decode:284 */
                disas_neon_dp_extract_2reg_shr_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VRSHR_S_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x00000300:
                /* 11110010 1....... ....0011 1..1.... */
                /* ../target/arm/neon-dp.decode:294 */
                disas_neon_dp_extract_2reg_shr_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VRSRA_S_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x00000500:
                /* 11110010 1....... ....0101 1..1.... */
                /* ../target/arm/neon-dp.decode:309 */
                disas_neon_dp_extract_2reg_shl_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VSHL_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x00000700:
                /* 11110010 1....... ....0111 1..1.... */
                /* ../target/arm/neon-dp.decode:324 */
                disas_neon_dp_extract_2reg_shl_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VQSHL_S_64_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x01000000:
                /* 11110011 1....... ....0000 1..1.... */
                /* ../target/arm/neon-dp.decode:269 */
                disas_neon_dp_extract_2reg_shr_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VSHR_U_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x01000100:
                /* 11110011 1....... ....0001 1..1.... */
                /* ../target/arm/neon-dp.decode:279 */
                disas_neon_dp_extract_2reg_shr_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VSRA_U_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x01000200:
                /* 11110011 1....... ....0010 1..1.... */
                /* ../target/arm/neon-dp.decode:289 */
                disas_neon_dp_extract_2reg_shr_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VRSHR_U_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x01000300:
                /* 11110011 1....... ....0011 1..1.... */
                /* ../target/arm/neon-dp.decode:299 */
                disas_neon_dp_extract_2reg_shr_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VRSRA_U_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x01000400:
                /* 11110011 1....... ....0100 1..1.... */
                /* ../target/arm/neon-dp.decode:304 */
                disas_neon_dp_extract_2reg_shr_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VSRI_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x01000500:
                /* 11110011 1....... ....0101 1..1.... */
                /* ../target/arm/neon-dp.decode:314 */
                disas_neon_dp_extract_2reg_shl_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VSLI_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x01000600:
                /* 11110011 1....... ....0110 1..1.... */
                /* ../target/arm/neon-dp.decode:319 */
                disas_neon_dp_extract_2reg_shl_d(ctx, &u.f_2reg_shift, insn);
                if (trans_VQSHLU_64_2sh(ctx, &u.f_2reg_shift)) return true;
                break;
            case 0x01000700:
                /* 11110011 1....... ....0111 1..1.... */
                /* ../target/arm/neon-dp.decode:329 */
                disas_neon_dp_extract_2reg_shl_d(ctx, &u.f_2reg_shift, insn);
