...
static struct proc_ops pde_proc_ops = {
    .proc_open = virtio_mini_open,
    .proc_read = virtio_mini_read,
    .proc_write = virtio_mini_write,
};
